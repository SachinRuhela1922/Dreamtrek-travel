...
if (loggedInUser) {
    userNameElement.textContent = loggedInUser.name; // Display user name
} else {
...
const redirectSpans = document.querySelectorAll('#redirectSpan');

// Add click event listener to each span
redirectSpans.forEach(span => {
    span.addEventListener('click', function() {
        const targetPage = this.getAttribute('data-target'); // Get the target page from data attribute
